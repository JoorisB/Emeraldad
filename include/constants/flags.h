...
#define FLAG_ROUTE103_DAD_RIVAL    0x30 // Route 103 Dad Fight
...
#define FLAG_HIDDEN_ITEM_LITTLEROOT_TOWN_ADAMANT_MINT        (FLAG_HIDDEN_ITEMS_START + 0x70)
#define FLAG_HIDDEN_ITEM_LITTLEROOT_TOWN_MODEST_MINT         (FLAG_HIDDEN_ITEMS_START + 0x71)
...
// Item Ball Flags
#define FLAG_ITEM_ROUTE_102_TM_BULK_UP                              0x3E8
...
#define FLAG_POKEMONPCMENU                          (SYSTEM_FLAGS + 0x21) // PC in Start Menu
