...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("HIKER"), 50 },
    [TRAINER_CLASS_TEAM_AQUA] = { _("TEAM AQUA") },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("{PKMN} BREEDER"), 50, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("COOLTRAINER"), 60, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("BIRD KEEPER"), 40 },
    [TRAINER_CLASS_COLLECTOR] = { _("COLLECTOR"), 75, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("SWIMMER♂"), 10, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("TEAM MAGMA") },
    [TRAINER_CLASS_EXPERT] = { _("EXPERT"), 50 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("AQUA ADMIN"), 50 },
    [TRAINER_CLASS_BLACK_BELT] = { _("BLACK BELT"), 40, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("AQUA LEADER"), 100, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("HEX MANIAC"), 30 },
    [TRAINER_CLASS_AROMA_LADY] = { _("AROMA LADY"), 50 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("RUIN MANIAC"), 75 },
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVIEWER"), 60 },
    [TRAINER_CLASS_TUBER_F] = { _("TUBER"), 5 },
    [TRAINER_CLASS_TUBER_M] = { _("TUBER"), 5 },
    [TRAINER_CLASS_LADY] = { _("LADY"), 240 },
    [TRAINER_CLASS_BEAUTY] = { _("BEAUTY"), 100 },
    [TRAINER_CLASS_RICH_BOY] = { _("RICH BOY"), 240 },
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIAC"), 75 },
    [TRAINER_CLASS_GUITARIST] = { _("GUITARIST"), 40 },
    [TRAINER_CLASS_KINDLER] = { _("KINDLER"), 40 },
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 20 },
    [TRAINER_CLASS_PICNICKER] = { _("PICNICKER"), 20 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("BUG MANIAC"), 75 },
    [TRAINER_CLASS_PSYCHIC] = { _("PSYCHIC"), 30 },
    [TRAINER_CLASS_GENTLEMAN] = { _("GENTLEMAN"), 100, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("ELITE FOUR"), 125, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("LEADER"), 125 },
    [TRAINER_CLASS_SCHOOL_KID] = { _("SCHOOL KID") },
    [TRAINER_CLASS_SR_AND_JR] = { _("SR. AND JR."), 20 },
    [TRAINER_CLASS_WINSTRATE] = { _("WINSTRATE"), 50 },
    [TRAINER_CLASS_POKEFAN] = { _("POKéFAN"), 100 },
    [TRAINER_CLASS_YOUNGSTER] = { _("YOUNGSTER"), 20 },
    [TRAINER_CLASS_CHAMPION] = { _("CHAMPION"), 250 },
    [TRAINER_CLASS_FISHERMAN] = { _("FISHERMAN"), 50, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("TRIATHLETE"), 50 },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DRAGON TAMER"), 60 },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA BOY"), 15 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("BATTLE GIRL"), 30 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("PARASOL LADY"), 50 },
    [TRAINER_CLASS_SWIMMER_F] = { _("SWIMMER♀"), 10, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("TWINS"), 15 },
    [TRAINER_CLASS_SAILOR] = { _("SAILOR"), 40 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("COOLTRAINER"), 25, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("MAGMA ADMIN"), 50 },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} TRAINER"), 75 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("BUG CATCHER"), 20 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 60 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("MAGMA LEADER"), 100, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("LASS"), 20 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("YOUNG COUPLE"), 40 },
    [TRAINER_CLASS_OLD_COUPLE] = { _("OLD COUPLE"), 50 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("SIS AND BRO"), 15 },
